...
export const CASE_STUDIES = [
  ...
  {
    slug: 'ipl-2025',
    title: 'IPL 2025 — Captivating Millennial & Gen Z Fans',
    category: 'Seasonal · Sports Marketing',
    pdf: 'https://customer-assets.emergentagent.com/job_gtm-leader/artifacts/b9vfqbuq_IPL.pdf',
    challenge: 'Help brands own the cultural mindshare of 400M+ Millennial & Gen Z cricket fans during IPL 2025 — without burning budget on undifferentiated ad inventory.',
    strategy: 'AI-driven contextual targeting layered with a curated package of cricket-themed websites & apps, TV-synced ad activations, hyperlocal targeting and immersive CTV/OTT formats.',
    execution: 'Built positioning, GTM narrative, sales decks and brand-side marketing for the IPL 2025 programmatic solution suite — pitched across BFSI, FMCG, auto and D2C advertisers.',
    results: ['400M+ Millennial & Gen Z fans addressable', 'Real-time TV-sync triggers for live match moments', 'CTV / OTT immersive formats for premium reach', 'Hyperlocal layer for footfall-driven brands'],
  },
  {
    slug: 'valentines',
    title: "Valentine's Day Programmatic Suite",
    category: 'Seasonal · Brand Campaign',
    pdf: 'https://customer-assets.emergentagent.com/job_gtm-leader/artifacts/x2t52gcl_Valentines%20.pdf',
    challenge: "Help brands cut through a noisy Valentine's window with creative that feels personal — and convert intent into footfall + sales.",
    strategy: 'Interactive rich-media formats + AI-powered in-image contextual placements + cross-channel TV-digital sync + hyperlocal targeting to drive shoppers and diners in-store.',
    execution: "Built the GTM narrative, sales collateral and brand marketing for Hybrid's Valentine's programmatic offering, anchored around contextual relevance and moment-marketing.",
    results: ['Interactive rich media for high engagement', 'AI in-image contextual placements', 'TV ↔ digital real-time sync', 'Hyperlocal targeting for retail & dining footfall'],
  },
];
...
export const PRODUCT_DECKS = [
  {
    slug: 'hybrid',
    company: 'Hybrid.ai',
    title: 'Hybrid — AI-Powered Programmatic Advertising',
    tagline: 'Global AdTech platform building the next generation of contextual, programmatic and TV-sync advertising.',
    summary: 'Corporate deck positioning Hybrid as a full-stack AI advertising company — spanning contextual intelligence, programmatic media, brand safety and immersive creative formats.',
    capabilities: [
      'AI-driven contextual intelligence',
      'Programmatic media & DSP integrations',
      'TV-Digital real-time sync',
      'Hyperlocal & geo-targeting',
      'CTV / OTT immersive formats',
      'Brand safety at scale',
    ],
    pdf: 'https://customer-assets.emergentagent.com/job_gtm-leader/artifacts/d3ll4apj_Hybrid%20.pdf',
    gradient: 'from-[#5B0FFF] to-[#D946EF]',
  },
  {
    slug: 'vox',
    company: 'Hybrid · VOX',
    title: 'VOX — Contextual Marketing Suite',
    tagline: 'Connect with consumers through advanced contextual AI — without cookies.',
    summary: 'VOX is a cookieless marketing suite that uses AI to analyze images, videos and text to understand the true meaning of a webpage — placing ads in high-attention zones beside genuinely relevant content.',
    capabilities: [
      'AI image, video & text content analysis',
      'Cookieless audience targeting',
      'Dynamic creative personalization (DCO)',
      'Interactive in-image ad formats',
      'Real-time brand safety filtering',
      'Attention-zone optimized placements',
    ],
    pdf: 'https://customer-assets.emergentagent.com/job_gtm-leader/artifacts/jt4nh3lo_VOX%20.pdf',
    gradient: 'from-[#8B1CF7] to-[#FF6B35]',
  },
];
